...
RSpec.describe User, type: :model do
  context 'test user model' do
    it 'create valid user' do
      u1 = User.create(name: 'salvador', email: 'q@q.com', 
                      password:'12345678', password_confirmation:'12345678')
      expect(u1.valid?).to eq(true)
    end

    it 'create invalid user' do
      u1 = User.create(name: 'Oscar Andrés Russi Porras de la fuente', email: 'q@q.com', 
        password:'12345678', password_confirmation:'12345678')
    ...
    it 'createda friendship between users' do
      u1 = User.create(name: 'Oscar', email: 'q@q.com', password:'12345678', password_confirmation:'12345678')
      u1.save
